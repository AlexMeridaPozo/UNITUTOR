...
class TutoriasPanel(wx.Panel):
    ...
    def ActualizarContador(self):
        ...
        # Contamos las tutorías con estado 'Realizada' (comparación case-insensitive)
        realizadas = len([
        ...
        # Mostramos además el número de realizadas para claridad
    ...
    def LoadTutorData(self):
        ...
        self.SaveTutoriasData(datos_iniciales)
        return datos_iniciales

    def SaveTutoriasData(self, data=None):
