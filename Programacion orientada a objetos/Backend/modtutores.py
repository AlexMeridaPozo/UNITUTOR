...
class TutoresModel(dv.DataViewIndexListModel):
    def __init__(self, data):
        ...
        # Valida cambios al editar una celda
    ...
    def Compare(self, item1, item2, col, ascending):
        ...
        # Compara el número del legajo y del año
        if col in [0, 3]:
            try:
    ...
    def DeleteRows(self, rows):
        # Elimina para atras apra que no haya desfase en el indice o legajo
...
class TutoresPanel(wx.Panel):
    def __init__(self, parent):
        ...
        datos_iniciales = self.CargarDatosTutor()
        ...
        # Se pone las columnas requeridas a la tabla de tutores
        ...
        # Pone el contador a la derecha y genera un espacio
...
class UNITORAppFrame(wx.Frame):
    ...
    #evento al apretar el boton "Acerca De"
