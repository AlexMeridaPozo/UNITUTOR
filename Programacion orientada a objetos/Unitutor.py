...
#Integrantes: Alex Merida Pozo - Candela Canteros - Franco Ingrata
...
#Botones de iniciar sesion y cerrar
        ...
        logo_bmp = wx.Bitmap(logo_img) #convierte la imagen en un bitmap para mostrar
        self.logo_ctrl = wx.StaticBitmap(self, bitmap=logo_bmp) #muestra la imagen en la interfaz
    ...
    #Logo pequeño para el borde de ventana al lado de titulo
        ...
        self.GetTopLevelParent().SetIcon(wx.Icon(logo_pequeño_bmp)) #convierte la imagen hecho bitmap como icono de la ventana
    # Usuario y Contraseña
        self.usuario = wx.TextCtrl(self, size=(220, -1)) #textctrl hace un cuadro para recibir un input
        self.contraseña = wx.TextCtrl(self, style=wx.TE_PASSWORD, size=(220, -1)) #el te_password hace que se vea con ****
